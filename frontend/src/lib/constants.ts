...
export const ENDPOINTS = {
  ...
  updateCategory: (id: string) => `${API_BASE}/categories/${id}`,
  ...
  pendingMigrations: `${API_BASE}/auth/pending-migrations`,
  completeMigration: `${API_BASE}/auth/complete-migration`,
  failMigration: `${API_BASE}/auth/fail-migration`,
