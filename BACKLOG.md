...
- [x] Categories management:
  ...
  - [x] Allow the user to edit the categories:
    - [x] Add categories
    - [x] Rename, set a fixed color, set an icon (use an icon picker and use lucide-react icons and a search bar to search for them). Add a button to enable/disable categories altogether and fall back to names and color only.
    - [x] Delete categories
