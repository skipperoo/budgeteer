...
func CreateAccount(w http.ResponseWriter, r *http.Request) {
	...
	account, err := service.Accounts.Create(r.Context(), claims.UserID, &req)
	if err != nil {
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(http.StatusInternalServerError)
		json.NewEncoder(w).Encode(model.Error{Error: err.Error()})
...
func DeleteAccount(w http.ResponseWriter, r *http.Request) {
	...
	accountID := r.PathValue("id")
	if err := service.Accounts.SoftDelete(r.Context(), accountID, claims.UserID); err != nil {
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(http.StatusForbidden)
		json.NewEncoder(w).Encode(model.Error{Error: err.Error()})
		return
...
func InviteToAccount(w http.ResponseWriter, r *http.Request) {
	claims, ok := r.Context().Value(middleware.ClaimsKey).(*model.UserClaims)
	if !ok || claims == nil {
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(http.StatusUnauthorized)
	...
	if err := service.Accounts.InviteUser(r.Context(), accountID, claims.UserID, req.UserEmail, req.EncryptedAccountKey); err != nil {
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(http.StatusBadRequest)
		json.NewEncoder(w).Encode(model.Error{Error: err.Error()})
		return
...
func ListAccountUsers(w http.ResponseWriter, r *http.Request) {
	...
	users, err := service.Accounts.ListUsers(r.Context(), accountID)
	if err != nil {
		w.Header().Set("Content-Type", "application/json")
...
func UpdateMyAccountKey(w http.ResponseWriter, r *http.Request) {
	claims, ok := r.Context().Value(middleware.ClaimsKey).(*model.UserClaims)
	if !ok || claims == nil {
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(http.StatusUnauthorized)
	...
	if err := service.Accounts.UpdateMyKey(r.Context(), accountID, claims.UserID, req.EncryptedAccountKey); err != nil {
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(http.StatusInternalServerError)
		json.NewEncoder(w).Encode(model.Error{Error: err.Error()})
		return
...
func RemoveAccountUser(w http.ResponseWriter, r *http.Request) {
	claims, ok := r.Context().Value(middleware.ClaimsKey).(*model.UserClaims)
	if !ok || claims == nil {
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(http.StatusUnauthorized)
	...
	accountID := r.PathValue("id")
	targetUserID := r.PathValue("uid")

	if err := service.Accounts.RemoveUser(r.Context(), accountID, claims.UserID, targetUserID); err != nil {
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(http.StatusForbidden)
		json.NewEncoder(w).Encode(model.Error{Error: err.Error()})
		return
